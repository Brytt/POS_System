...
class OS_Pagination {
    ...
    function __construct($sql,$sqlquery, $rows_per_page = 20, $links_per_page = 10, $append = "",$input_array="") {
...
//                echo "Query returned zero rows.";
    ...
    function limitList($limit,$formname){
        ...
        echo '<select name="limit" onchange="document.'.$formname.'.submit()" class="shortes">
