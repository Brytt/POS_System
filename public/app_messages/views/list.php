...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-sm-12 col-md-6">
			<p class="mb-4">A list of messages </p>
		</div>
		<div class="col-sm-12 col-md-6">
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<?php 
										...
										<div class="row">
											<div class="col-lg-1">
												<div class="dropdown-list-image mr-3">
													<img class="rounded-circle" src="https://source.unsplash.com/fn_BT9fwg_E/60x60" alt="" style="height: 3em; width: 3em;">
											...
											<div class="col-lg-11">
												<div class="font-weight-bold">
													...
													<div class="small text-gray-500"><?php echo $val['MESG_DATEADDED']; ?></div>
												</div>
											</div>
										</div>
									</div>
								...
								<?php
										if($val['MESG_STATUS'] == "0"){
								?>

								<?php
										}else if($val['MESG_STATUS'] == "1"){
								?>
