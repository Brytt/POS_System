	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<div class="row">
				...
				<div class="col-sm-6">
					<a href="javascript:void(0);" onclick="$('#pg').val('app_reports');$('#view').val('sales_report');$('#class_call').val('sales_report');$('#keys').val('<?php echo ''; ?>');document.myform.submit();" class="btn btn-success btn-icon-split" style="float: right;">
						<span class="icon text-white-50">
