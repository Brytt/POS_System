<?php 
 namespace app_expenses;
  class add_category extends \setup { 
      ...
      function Init(){
        // if($this->engine->validatePostForm($this->microtime)){  
          ...
          if($stmt == true){
            ...
            $reqtitle = $this->expencecategory_name;
            $reqtype = "Added Expense Category";
            $reqicon = "fas fa-money-bill-wave";
            ...
            $act_reqtitle = $this->expencecategory_name;
            $act_reqtype = "Added Expense Category";
            $act_reqicon = "fas fa-money-bill-wave";
