					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area"><input type="text"
										class="form-control" id="product_name" name="product_name" value=""></div>
							</div>
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area"><input type="number"
										class="form-control" id="product_purchaseprice" name="product_purchaseprice" value=""></div>
							</div>
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area"><input type="number"
										class="form-control" id="product_salesprice" name="product_salesprice" value=""></div>
							</div>
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area">
									<textarea class="form-control" name="product_description" id="" cols="30" rows="5"></textarea>
								</div>
							</div>
						...
						<div class="col-sm-6">
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area"><input type="number"
										class="form-control" id="product_speccode" name="product_speccode" value=""></div>
							</div>
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area"><input type="number"
										class="form-control" id="product_taxrate" name="product_taxrate" value=""></div>
							</div>
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area"><input type="number"
										class="form-control" id="product_quantity" name="product_quantity" value=""></div>
							</div>
							...
							<div class="form-group row showcase_row_area">
								...
								<div class="col-md-9 showcase_content_area"><input type="number"
										class="form-control" id="product_minquantity" name="product_minquantity" value=""></div>
							</div>
