  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-sm my-5" style="margin-top: 4em !important;">
          <div class="card-body p-0">
            ...
            <form class="user" action="#" method="post" enctype="application/x-www-form-urlencoded" name="myform" id="loginForm" autocomplete="off">
              ...
              <div class="row" style="padding: 2em 4em;">
                  ...
                  <div class="col-lg-12 ">
                  <div class="row justify-content-center">
                   <img src="media/images/apitech.png" style="width: 25%;margin: 2em 0em;" alt=""> 
                  </div>
                    <h1 class="h4 text-gray-900 mb-4" style="text-align: center">Set Up Account on API TECHNOLOGIES POS!</h1>
                    <br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="email" class="form-control " id="admin_fname" aria-describedby="emailHelp" name="admin_fname">
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="comp_name" aria-describedby="emailHelp" name="comp_name">
                          </div>
                      ...
                      <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="email" class="form-control " id="admin_lname" aria-describedby="emailHelp" name="admin_lname">
                          </div>
                      ...
                      <div class="col-lg-12" style="text-align: center;">
                        <a href="index.php?action=login" onclick="toggle_div()" class="btn btn-dark  btn-block" style="width: 10em;float: left;">
                          &#8592; Back
                        </a>
                        <a href="javascript:void(0);" onclick="toggle_div()" class="btn btn-info  btn-block" style="width: 10em;float: right;">
                          Next &#8594;
                        </a>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="email" class="form-control " id="comp_email" aria-describedby="emailHelp" name="comp_email">
                          </div>
                          ...
                          <!-- <div class="form-group">
                            ...
                            <textarea  class="form-control " name="comp_description" id="comp_description" cols="30" rows="2"></textarea>
                          </div> -->
                      ...
                      <div class="col-lg-6">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="comp_website" name="comp_website">
                          </div>

                          <div class="form-group">
                            <label for="">Confirm Password <span>*</span></label>
                            <input type="password" class="form-control " id="admin_cpwd" name="admin_cpwd">
                          </div>
                      ...
                      <div class="col-lg-6" style="text-align: center;">
                        <a href="javascript:void(0);" onclick="toggle_div()" class="btn btn-dark  btn-block" style="width: 10em;float: left;">
                          &#8592; Back
                        </a>
                      </div>

                      <div class="col-lg-6" style="text-align: center;">
                        <a href="javascript:void(0);" onclick="document.myform.submit();" class="btn btn-info  btn-block" style="width: 10em; float: right;">
                          Submit &#8594;
                        </a>
                      </div>
    ...
    if(!empty($admin_fname) && !empty($admin_email) && !empty($admin_pwd) && !empty($admin_lname) && !empty($admin_phone) && !empty($admin_cpwd)){
      ...
      if($admin_pwd == $admin_cpwd){
        ...
        if($stmt->RecordCount() == 0){
          ...
          $stmt_insert =$sql->Execute($sql->Prepare("INSERT INTO app_users (USR_CODE, USR_FIRSTNAME, USR_PHOTO, USR_ACCESS_LEVEL, USR_COMPANY_CODE, USR_BRANCH_CODE, USR_STATUS, USR_LASTLOGIN_DATE, USR_LOGIN_STATUS, USR_EMAIL, USR_USERNAME, USR_COUNTRY, USR_GENDER, USR_OTHERNAME, USR_PASSWORD, USR_DATE_ADDED, USR_ACTOR_ID, USR_ACTOR_COMPCODE) VALUES(".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').",".$sql->Param('a').")"),array($gen_user_code, $admin_fname, "", 2, $gen_user_comp_code, $gen_user_brance_code, "1", $dateAdded, "0", $admin_email, $admin_email, "Ghana", null, $admin_lname, $password, $dateAdded, $gen_user_code, $gen_comp_code));
          print $sql->ErrorMsg();
          ...
          if($stmt_insert == true){
            ...
            if($stmt_comp == true){
              ...
              echo '<script language="javascript">';
              echo 'alert("Try again: Couldn\'t Company Details ")';
              echo '</script>';
            }

          }else{
            echo '<script language="javascript">';
            echo 'alert("Try again: Couldn\'t Your Details ")';
            echo '</script>';
          }
