      ...
      function Init(){
        // if($this->engine->validatePostForm($this->microtime)){  
          ...
          if($stmt == true){
            ...
            $message = "You updated-Add ".$this->product_name." more stock to ".$this->product_quantity." ";
            $type = "2";
            ...
            $act_message = "You updated-Add ".$this->product_name." more stock to ".$this->product_quantity." ";
            $act_type = "2";
