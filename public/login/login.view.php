        ...
        <div class="card o-hidden border-0 shadow-sm my-5" style="margin-top: 4em !important;">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <!-- bg-login-image -->
                <img src="media/images/loginbg.jpg" style="width: 100%;margin: 2em 0em;" alt="">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                  <img src="media/images/apitech.png" style="width: 50%;margin: 2em 0em;" alt="">
                  </div>
                  <form class="user" action="index.php?action=index&pg=1" method="post" enctype="application/x-www-form-urlencoded" name="myform" id="loginForm" autocomplete="off">
                    ...
                    <a href="javascript:void(0);" onclick="document.myform.submit();" class="btn btn-info btn-user btn-block">
                      Login
                    </a>
                  </form>
                  <hr>
