...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">DEBTOR LIST</h6>
		</div>
		<div class="card-body">
			...
			<a href="javascript:void(0);" onclick="$('#pg').val('app_staff');$('#view').val('add');document.myform.submit();" class="btn btn-primary btn-icon-split" style="float: right;">
				...
				<span class="text">Add Debtor</span>
			</a>
		</div>
							...
							<table class="table table-striped text-nowrap" id="dataTable" width="100%" cellspacing="0"
								...
								<thead>
									<tr role="row">
										...
										<th class="sorting_asc" tabindex="0" aria-controls="dataTable" 			rowspan="1" colspan="1" aria-sort="ascending"
											aria-label="Name: activate to sort column descending"
											style="width: 150px;">Debtor's Name</th>
										<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
											colspan="1" aria-label="Position: activate to sort column ascending"
											style="width: 140px;">Contact</th>
										<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
								...
								<tbody>
									...
									<tr role="row" class="odd">
										...
										<td><?php echo $val['DEBT_NAME']; ?></td>
										<td><?php echo $val['DEBT_CONTACT']; ?></td>
										<td><?php echo $val['DEBT_EMAIL']; ?></td>
										<td><?php echo $val['DEBT_AMOUNT']; ?></td>
										<td><?php echo $val['DEBT_ADDRESS']; ?></td>
										<td><?php echo $val['DEBT_DATE_ADDED']; ?></td>
										<td> 
											<div class="row">
												<?php
												...
												<div class="col-sm-12 col-md-5">
													<a  href="javascript:void(0);" onclick="$('#pg').val('app_debtors');$('#view').val('edit');$('#class_call').val('details');$('#keys').val('<?php echo $data; ?>');document.myform.submit();" class="btn btn-warning btn-icon-split" >
														<span class="icon text-white-50">
												...
												<div class="col-sm-12 col-md-5">
													<a  href="javascript:void(0);" onclick="$('#pg').val('app_debtors');$('#view').val('delete');$('#class_call').val('delete');$('#keys').val('<?php echo $val['DEBT_CODE']; ?>');delete_func()" class="btn btn-danger btn-icon-split" >
														<span class="icon text-white-50">
