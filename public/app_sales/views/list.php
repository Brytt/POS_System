							...
							<table class="table table-striped text-nowrap" id="dataTable" width="100%" cellspacing="0"
								...
								<thead>
									<tr role="row">
										...
										<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
											...
											style="width: 128.2px;">Total Amount (<del>&#8373;</del>)</th>
										<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
											colspan="1" aria-label="Salary: activate to sort column ascending"
											style="width: 118px;">Amount Paid (<del>&#8373;</del>)</th>
										<!-- <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
											colspan="1" aria-label="Salary: activate to sort column ascending"
								...
								<tbody>
									...
									<tr role="row" class="odd">
										...
										<td><?php echo date('d/m/Y',strtotime($val['SALE_DATEADDED'])); ?></td>
										...
										<td> 
											<div class="row">
												...
												<div class="col-sm-12 col-md-5">
													<a  href="javascript:void(0);" onclick="$('#pg').val('app_products');$('#view').val('details');$('#class_call').val('details');$('#keys').val('<?php echo $data; ?>');document.myform.submit();" class="btn btn-info btn-icon-split" >
														<span class="icon text-white-50">
